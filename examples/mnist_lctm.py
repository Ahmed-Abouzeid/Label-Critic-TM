...
pattern_search_perc = 0.90 # percentage of all labels learning automata that must be rewarded together to accept their labels
    ...
    for num_clauses in num_clauses_l:
        for T in T_l:
            ...
            for S in S_l:
                ...
                lctm.fit(num_clauses, num_features, [X_train], augments=augments)
